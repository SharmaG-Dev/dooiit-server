...
var createUser = function (data) { return __awaiter(void 0, void 0, void 0, function () {
    var hashPass, userInput, res;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                hashPass = (0, func_1.HashPassword)({ password: data.password });
                userInput = {
                    email: data.email,
                    name: data.name,
                    password: hashPass,
                    ...
                    providerType: data === null || data === void 0 ? void 0 : data.providerType,
                };
                return [4 /*yield*/, Client_1.client.user.create({ data: userInput })];
            case 1:
                res = _a.sent();
                return [2 /*return*/, res];
        }
...
var UpdateUser = function (id, data) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, Client_1.client.user.update({
                    where: {
                        id: id
                    },
                    data: data
...
var getUser = function (id) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, Client_1.client.user.findUnique({
                    where: {
                        id: id
                    }
                })];
...
var getUsers = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, Client_1.client.user.findMany()];
            case 1:
                res = _a.sent();
                return [2 /*return*/, res];
        }
...
var findUser = function (data) { return __awaiter(void 0, void 0, void 0, function () {
    var res;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, Client_1.client.user.findFirst({
                    where: data
                })];
            case 1:
                res = _a.sent();
...
var deleteUser = function (id) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, Client_1.client.user.delete({
                    where: {
                        id: id
                    }
                })];

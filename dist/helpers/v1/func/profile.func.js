...
var createProfile = function (data) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, Client_1.client.profile.create({
                    data: {
                        user: {
...
var UpdateProfile = function (id, data) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, Client_1.client.profile.update({
                    where: {
                        id: id
                    },
                    data: data
...
var getProfile = function (id) { return __awaiter(void 0, void 0, void 0, function () {
    var _res;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, Client_1.client.profile.findUnique({
                    where: {
                        id: id
                    }
                })];
...
var getProfiles = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, Client_1.client.profile.findMany()];
            case 1:
                _res = _a.sent();
                return [2 /*return*/, _res];
        }

...
function createTransaction(data) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            return [2 /*return*/, prisma.transactions.create({
                    data: {
                        ...
                        refundId: (_b = data.refundId) !== null && _b !== void 0 ? _b : null
                    }
                })];
        });
    });
...
function getTransactionById(id) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, prisma.transactions.findUnique({ where: { id: id } })];
        });
    });
}
...
function listTransactions(filter) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            if (filter === null || filter === void 0 ? void 0 : filter.paidById)
                whereClause.paidById = filter.paidById;
            return [2 /*return*/, prisma.transactions.findMany({
                    where: whereClause,
...
function updateTransaction(id, updates) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            return [2 /*return*/, prisma.transactions.update({
                    where: { id: id },
                    data: {
                        ...
                        refundId: (_a = updates.refundId) !== null && _a !== void 0 ? _a : undefined
                    }
                })];
        });
    });
...
function deleteTransaction(id) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, prisma.transactions.delete({ where: { id: id } })];
        });
    });
}

...
var handleCreateUser = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, name_1, email, password, _userExists, _createUser, error_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                _userExists = _b.sent();
                if (_userExists)
                    return [2 /*return*/, (0, response_1.failResponse)(res, 409, null, "Email Already Exists")];
                return [4 /*yield*/, (0, user_func_1.createUser)({ name: name_1, email: email, password: password })];
            case 2:
                _createUser = _b.sent();
                return [2 /*return*/, (0, response_1.successResponse)(res, 201, _createUser, "User Created Successfully")];
            case 3:
                error_1 = _b.sent();
...
var handleUpdateUser = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var id, data, _updateUser, error_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                id = req.params.id;
                data = req.body;
                return [4 /*yield*/, (0, user_func_1.UpdateUser)(id, data)];
            case 1:
                _updateUser = _a.sent();
                return [2 /*return*/, (0, response_1.successResponse)(res, 200, _updateUser, "User Updated Successfully")];
            case 2:
                error_2 = _a.sent();
